              ...
              >
                ...
                <YAxis
                  label={{
                    ...
                    angle: 0, // Make it horizontal (0 degrees)
                    position: "top",
                    offset: 20, // Move it up a bit from the chart
                    dy: 5, // Additional fine-tuning of vertical position
                    dx: 30,
                    fill: "#6B7280", // Match the text color with other labels
                    fontSize: 12,
                  }}
                  tick={{ fontSize: 12 }}
                ...
                <ReferenceLine
                  ...
                  strokeDasharray="3 3"
                  label={{
                    value: `Avg: ${scores.averageResponseTime}`,
                    position: "left",
                    fill: "#FFA500",
                    fontSize: 12,
